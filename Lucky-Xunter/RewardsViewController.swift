...
class RewardsViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let attributedText = NSAttributedString(string: reward.title, attributes: [NSAttributedString.Key.foregroundColor: UIColor(ciColor: .cyan), NSAttributedString.Key.font: UIFont(name: "AvenirNext-Heavy", size: 16)])
