...
//            slotsPicker.widthAnchor.constraint(equalToConstant: dynamic.constraintPortrait(414)),
...
//        let pickerImageView = UIImageView(frame: CGRect(x: 0, y: 0, width: dynamic.constraintPortrait(414/7), height: dynamic.constraintPortrait(414/7)))
