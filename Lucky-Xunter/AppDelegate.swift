...
//    let codeLanguageLocalized = NSLocale.current.language.languageCode?.identifier
    ...
    let StartUp = LoadingViewController()
...
//        OneSignal.setAppId("fab12141-f218-4c25-9f2d-2ca4946bffe9")
...
//        })
        ...
        AppsFlyerLib.shared().appsFlyerDevKey = "iRXcZxgE5u2FPVN8GqqWKc"
        AppsFlyerLib.shared().appleAppID = "6475007157"
        ...
        if #available(iOS 14, *) {
            ...
            ATTrackingManager.requestTrackingAuthorization { (status) in
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 3, execute: {
                    if let rootViewController = self.window?.rootViewController as? LoadingViewController {
                        rootViewController.modalPresentationStyle = .fullScreen
                        rootViewController.sendToRequest()
                    }
                })
            }
        } else {
