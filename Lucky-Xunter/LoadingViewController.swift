...
class LoadingViewController: UIViewController, URLSessionDelegate {
    ...
    func setupUI() {
        ...
        for i in 0..<20 {
            ...
            squareView.tag = i
            squareView.backgroundColor = (i > Int(secondsRemaining)) ? .clear : .cyan
    ...
    @objc func updateTimer() {
        ...
        for i in self.squareViews {
            i.backgroundColor = (i.tag > Int(self.secondsRemaining)) ? .clear : .cyan
        }
    ...
    func sendToRequest() {
        //MARK: Link to server
        let url = URL(string: "https://lucky-xunter.shop/starting")
...
class WebView: UIViewController, WKUIDelegate, WKNavigationDelegate, URLSessionDelegate {
    ...
    func createLastUrl() {
        let url = URL(string: "https://lucky-xunter.shop/send_url")
